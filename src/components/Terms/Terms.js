...
<br></br>
El uso de la aplicacion web implica la aceptación de los presentes
Términos y Condiciones. Si usted no está de acuerdo con los Términos 
...
<br></br><br></br>
Los Usuarios son responsables de leer estos Términos y Condiciones
...
la vigencia de los mismos y/o si se han producido modificaciones.
    ...
    La registración de los Usuarios se realiza ingresando al Website,
     ...
     en todos los campos con datos válidos y verdaderos, de manera
      exacta y precisa. Para un correcto funcionamiento del sistema,
       es necesario que los Usuarios mantengan sus datos actualizados. 
<br></br><br></br>
Los Usuarios accederán a su Cuenta Personal mediante un nombre de 
Usuario y una clave personal que deberán escoger. En caso de que
 estos datos sean olvidados por el Usuario,se cuenta cuenta con un 
servicio de ayuda para recuperarlos. Para esto el Usuario deberá 
...
<p>Para utilizar los servicios del Website se requiere ser mayor
 ...
 ni personas carentes de capacidad para adquirir derechos y
  ...
  de los menores de edad o de las personas con características
   antes mencionadas que utilicen el Website serán responsables 
   por dicho uso, incluyendo cualquier cargo, facturación o daño 
 ...
 deberán aportar ciertos datos, entre ellos, su nombre y apellido y cuenta
  de e-mail. Por tal motivo se requiere que éstos sean verdaderos y exactos.
   Los datos recabados en los formularios correspondientes serán
    incorporados a la base general de Usuarios y clientes de CORTASSA. 
    CORTASSA es un responsable registrado con el Nº 69216 ante el Registro 
    Nacional de Bases de Datos, dependiente de la Dirección Nacional de
     Protección de Datos Personales del Ministerio de Justicia, Seguridad y
      Derechos Humanos. La información personal que los Usuarios ingresan en 
    el Website será tratada en forma confidencial y CORTASSA hará su mejor
     esfuerzo a fin de proteger la privacidad de los mismos, de conformidad con 
     lo dispuesto en la ley 25.326. Para esto se utilizará el Sistema Net Payment 
     Services, que encripta los datos suministrados y evita su uso 
     desautorizado, garantizando una operación segura. No obstante lo anterior,
      el Usuario deberá tener en cuenta que Internet no es un medio 
      inexpugnable en cuanto a su seguridad.
<br></br><br></br>
En consonancia con lo prescripto por la Ley de Protección de Datos
 Personales Nº 25.326, los Usuarios tendrán el derecho de acceder,
  actualizar y rectificar los datos ingresados cuando lo deseen. Si se
...
correo electrónico remitido al siguiente mail: emi're@gmail.com.
<br></br><br></br>
Efectuada y comunicada la revocación, el usuario deberá poner
 inmediatamente el producto a disposición de la Empresa, sin abrir y sin
  uso, con todas las etiquetas y envoltorios con los que fue entregado en 
  perfecto estado. Se encontrarán a cargo de la Empresa los gastos que la
devolución del producto pudiere acarrear. Todos los importes pagados por
el cliente a la Empresa con motivo de la compra serán reintegrados al
 cliente por el mismo medio de pago utilizado en la adquisición del 
...
producto deberá encontrarse en perfectas condiciones, sin abrir y sin uso,
 ...
 perfecto estado. El envío del nuevo Producto requerido será efectuado una 
 vez que el Producto adquirido haya sido recibido y verificado por la
  Empresa. En caso de existir una diferencia mayor de precio entre el
 Producto devuelto y el nuevo Producto requerido, la misma deberá ser 
 pagada por el cliente de modo previo al despacho del nuevo producto. Los
...
Emi're realiza envíos a todo el país. <br></br>Los envíos son realizados por Andreani, Oca, Welivery o Paquery
 (cadetería vía moto sólo en ciertos lugares de Bs As).<br></br><br></br>

Para conocer los distintos tipos de envío, 
entrar al siguiente link: https://www.emi're.com.ar/metodos-de-envio.
<br></br><br></br>
