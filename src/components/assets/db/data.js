/* import imagen1 from '../imgs/descarga.png' */
...
export const data = [
    ...
    "marca":"ONE MILLION",
    "categoria":"perfumehombre",
    "description": "Arriésgate y vive la vida al extremo, porque no siempre hay que obedecer reglas. Perseguir tus sueños también es importante. El perfume One Million te ofrece una fragancia con notas de cuero y toques picantes para que puedas vivir tu lado más atrevido. La vida es demasiado corta como para seguir siempre las reglas. Atrévete a hacer realidad tus sueños y a presumir de tu personalidad. Con One Million eau de toilette seducirás por sus notas de cuero, ámbar y mandarina.",
    "price":"37.750",
    ...
    "marca":"AZZARO",
    "categoria":"perfumehombre",
    "description": "Es de gran importancia tener un buen aroma, es por eso que se han creado numerosas fragancias que nos ayudan en esta tarea. Hay una gran variedad de perfumes entre los cuales se puede elegir. Si lo que buscas es resaltar tu personalidad, presencia y masculinidad, entonces esta fragancia para hombres es el ideal para ti, gracias a su fragancia de la familia olfativa aromática fougere, seguramente no pasarás desapercibido. Para las mejores ocasiones de tu vida o en general para cuando quieras.Ideal para hombres a los que les gusta llamar la atención, te ofrece una exquisita combinación de aromas para que resaltes tu esencia y masculinidad natural.",
    "price":"14.598",
    ...
    "price":"63.800",
    "categoria":"perfumehombre",
    "description": "El frescor potente de Sauvage exhala nuevas facetas sensuales y misteriosas, renovando ampliamente la firma con una composición virtuosa. La Bergamota de Calabria, siempre tan chispeante y jugosa, incorpora nuevas notas especiadas, aportándole profundidad y sensualidad. Por su parte, la estela amaderada y ambarina del Ambroxan® se envuelve en un absoluto de Vainilla de Papúa Nueva Guinea, con acentos ahumados que aportan masculinidad. François Demachy, Perfumista-Creador Dior, se inspiró en el desierto a la hora mágica del atardecer. El frescor de la noche junto con el ardiente aire del desierto exhala aromas intensos. En esa hora en la que los lobos aparecen y el cielo se enciende, se despliega una nueva magia. ",
    "marca":"DIOR",
    ...
    "price":"9.050",
    "marca":"SALVADOR DALI",
    "description":"Eau de Rubylips rinde homenaje a la boca daliniana a través de las líneas puras y barrocas del frasco y de las cinco bocas grabadas en el vidrio. Ruby Lips se inspira en el broche creado por Salvador Dalí, y las bocas evocan la fascinación del artista por este símbolo femenino.La fragancia de tono azul claro y la transparencia del vidrio juegan con la luz para reflejar las notas aéreas de Eau de Rubylips. Las notas de flores blancas envuelven a la flor de algodón y se mezclan con las notas afrutadas de pomelo y piña para componer una fragancia femenina, tierna y fresca.",
    ...
    "marca":"BENTLEY",
    "categoria":"perfumehombre",
    "description": "Bentley For Men refleja un estilo de vida, lujoso y de distintivo diseño. Fue creada para el hombre con metas altas, al que solo lo satisfice lo mejor de lo mejor. Inspirado en el cuero más fino y maderas exquisitas, esta combinación le da a la fragancia una estructura fuerte y masculina. Una fragancia impactante para hombres lo suficientemente audaces como para usar una fragancia ultra lujosa pero extremadamente sensual.",
    ...
    "categoria":"perfumemujer",
    "description":"Brillante y enérgico, Sunflowers Sunrise vigoriza los sentidos con frescura y placer. Una fragancia que captura el momento más precioso cuando los pétalos abrazan el sol de la mañana.",
    ...
    "marca":"PORTSAID",
    "categoria":"perfumemujer",
    "description": "Una fragancia Amaderada-Frutada de poderosas notas principales de la Manzana y las Fresias, logran combinarse muy bien junto a las Maderas de Cedro y Violetas.Dando lugar a las notas de fondo del Ambroxane y semillas de Ambreta para poder tener finalmente un bálsamo adictivo.",
    ...
    },
   {
    ...
    "marca":"CLAVIN KLEIN",
    "categoria":"perfumehombre",
    "description": "Pariente del Eternity, nos presenta una faceta más juvenil, contemporánea y desenfadada de la clásica fragancia. Un aroma romántico, que nos relata una bonita y verdadera historia de amor.",
    ...
    "marca":"MOLYNEUX",
    "categoria":"perfumehombre",
    "description":"Captain de Molyneux es una fragancia de la familia olfativa Amaderada Aromática para Hombres. Captain se lanzó en 1975. Las Notas de Salida son bergamota, jengibre y anís; las Notas de Corazón son lavanda, flor de azahar del naranjo y hojas de violeta; las Notas de Fondo son madera de gaiac, musgo y sándalo.",
    ...
    "marca":"CLAVIN KLEIN",
    "categoria":"perfumehombre",
    "description":"Un eau de parfum cuyos ingredientes de lujo se han escogido para enfatizar la fragancia original, darle mas textura y carisma. Cuenta con un excelente poder de permanencia y ofrece una experiencia de fragancia duradera, verdaderamente intensa y atrevida.",
    ...
    "marca":"BENTLEY",
    "categoria":"perfumehombre",
    "description":"Esta interpretacion de Bentley For Men esta inspirada por el automovil convertible Azure, lanzado en 2006. Con la premisa de ser el mejor en su clase, Bentley Azure refleja los valores de la marca en esta fragancia atractiva, poderosa y energizante. Una expresion moderna de frescura y larga duracion. Una creacion que personifica la modernidad masculina.",
    ...
    "categoria":"perfumemujer",
    "description":"My Way Intense te invita a redescubrirte a vos misma a través de su nueva intensidad. Un bouquet floral, potente y luminoso, con una estela amaderada y penetrante que encapsula experiencias únicas y encuentros auténticos vividos alrededor del mundo.Una floralidad intensa con una estela amaderada adictiva, a base de ingredientes de origen sostenible. El perfume comienza con notas chispeantes de azahar de Egipto. El nuevo e intenso corazón de nardo de la India revela una faceta cremosa y aterciopelada del aroma floral. En el fondo del perfume, la madera de sándalo de Nueva Caledonia adquiere un adictivo toque cremoso cuando se encuentra con la sensual vainilla de Madagascar.Una fragancia comprometida, concebida a través del ecodiseño y la protección de la biodiversidad que te anima a vivir la sustentabilidad desde otra perspectiva.Con My Way Intense anímate a vivir a tu manera, intensamente.",
    ...
    "marca":"SHAKIRA",
    "categoria": "perfumemujer",
    "description":"Con Dream, Shakira narra de forma muy personal cómo su sueño de hacer música se convirtió en realidad. Dream es una esencia joven y adictiva con la que compartir la experiencia de Shakira y atreverse a luchar para hacer que nuestros sueños de futuro se hagan realidad. Un perfume femenino y con carácter.",
...
"categoria": "perfumemujer",
"description":"Irresistible, incitadora y con un toque de misterio, una fragancia para la mujer seductora que todas llevamos dentro . Creada para la mujer que es magnetica y intrigante, una fragancia coqueta que siempre te deja queriendo más.",
...
"categoria": "perfumemujer",
"description":"Pura vitalidad en notas de bergamota, limón y artemisa. Perfecto acorde con ámbar, cedro y sándalo y un toque exótico de semillas de Tonka.",
...
"description":"Mezclando perfectamente dos colores contrastantes, el lápiz labial Le Rouge Sculpt 5 Rose de Givenchy Beauty es como la versión de maquillaje de un balayage perfecto.",
...
"marca":"CLINIQUE",
"categoria": "maquillaje",
"description":"Fórmula sedosa que se desliza fácilmente y dura todo el día. Úsalo para definir la línea de los labios o para rellenarlos antes de aplicar tu labial. Su fórmula no reseca, evita que el labial se corra. No requiere de sacapuntas.",
...
"marca":"GIVENCHY",
"categoria": "maquillaje",
"description":"Como un labial líquido, Encre Interdite envuelve los labios en una capa fina que hidrata durante 6 horas al misto tiempo que brinda una cobertura total de color intenso sin transparencias y resistente al agua hasta por 24 horas. Con sólo una pasada, su alta concentración de agua permite sellar los colorantes en el labio como un tatuaje y proporciona una sensación única de labios desnudos. Encre Interdit posee extracto de rosa negra enriquecido con polifenoles antioxidantes que ayuda a proteger los labios contra el envejecimiento y los alivia, además contiene glicerina vegetal que ayuda a hidratar los labios al mismo tiempo en que mantiene el confort.",
...
"marca":"GUERLAIN",
"categoria": "maquillaje",
"description":"Kiss : Una nueva textura cremosa reclutadora. Comodidad extrema, uso diario, efecto moldeador. La evocación inmediata de la tentación, Kiss incita a la emoción y da glamour a los labios. Esta elegante barra de labios viste los labios con un resplandor luminoso y garantiza suavidad y comodidad duradera. El placer de una textura sedosa y gourmand para unos labios que se vuelven carnosos y apetecibles. La encarnación de un estilo chic impecable, Kiss se puede usar con todo para cualquier ocasión. Los labios son suaves, lisos y brillantes, adornados con colores puros como piedras preciosas. Cada uno de los tonos preciosos y satinados con sus nombres poéticos es una declaración resplandeciente de feminidad.",
...
"marca":"CHER",
"categoria": "maquillaje",
"description":"Sombra compacta trio HD con filtro solar. Acabado HD, color intenso y protección. Tamaño 47 gr.",
...
"marca":"MAC",
"categoria": "maquillaje",
"description":"Todo el efecto metálico extremo de Dazzleshadow Extreme disponible en pastillas para armar tu M·A·C PRO Palette. Su textura ofrece efecto metálico extremo, alta saturación de color en la primera aplicación, extendiendo su poder durante 12 horas.",
...
"marca":"L'OREAL PARIS",
"categoria": "maquillaje",
"description":"Máscara de pestañas con aceite de ricino, su cepillo con fibras rectas y onduladas permite conseguir una mirada de alto impacto de una sola pasada. Gran volumen al instante, aplicación ultra suave y apto para ojos sensibles.",
...
"marca":"L'OREAL PARIS",
"categoria": "maquillaje",
"description":"Máscara de pestañas que proporciona un volumen espectacular y longitud máxima, dejando las pestañas suaves.",
...
"marca":"MAC",
"categoria": "maquillaje",
"description":"Nuestra fórmula moderna e híbrida combina la suavidad de la crema, el fácil difuminado del fluido y el acabado del polvo con la larga duración del color y los reflejos multicolores. Con una gama que va de suaves pasteles a corales y ciruelas, proporcionando una textura luminosa y deja un sutil acabado segunda piel.",
...
"marca":"GUERLAIN",
"categoria": "maquillaje",
"description":"Un rubor suave que realza la tez natural. Contiene pigmentos únicos para capturar la luz natural. Realza visiblemente el tono rosado natural de las mejillas. Brinda un acabado fresco con un brillo delicado. Impregnado con extracto de aceite de rosa para dar un tinte de color sutil. Ligero y se desliza fácilmente",
"image":"https://d3cdlnm7te7ky2.cloudfront.net/media/catalog/product/cache/d7c384551f5371795a81d64f480f8258/r/v/rv116208.jpg"
},
...
"marca":"SALLY HANSEN",
"categoria": "maquillaje",
"description":"Capa protectora en gel de larga duración. Su fórmula es 5 Free (Formaldehído, Tolueno, Ftalato de dibutilo (DBP), Resina de formaldehído y Alcanfor) y extiende la duración del color. Está diseñada especialmente para usar en conjunto con nuestro esmalte Miracle Gel color. Podés elegir entre un acabado mate o brilloso en función de tus preferencias.",
...
"marca":"OPI",
"categoria": "maquillaje",
"description":"Todo en uno! Esta fórmula 3 en 1 combina la capa base, superior y fortalecedor de uñas. Esmalte de uñas para aplicar como base y conseguir un acabado brillante y natural mientras nutres y proteges las uñas. Base fortalecedora y protectora que nutre las uñas y les aporta un acabado brillante y natural que nos ayuda a evitar las roturas, las manchas y los tonos amarillentos. Además, contribuye a fijar y hacer más duraderos tus esmaltes de uñas con color.",
"image":"https://d3cdlnm7te7ky2.cloudfront.net/media/catalog/product/cache/3caedb57c154f4c66adc1fae2b6a3bf5/F/M/FM16614BI23111_RV109468_SZ6.jpg"
},
...
"marca":"OPI",
"categoria": "maquillaje",
"description":"Capa superior efecto MATE (sin brillo) para los tonos regulares de laca. Se utiliza como paso final en de manicura para sellar el color y extender el desgaste.",
...
"marca":"CHER",
"categoria": "maquillaje",
"image":"https://d3cdlnm7te7ky2.cloudfront.net/media/catalog/product/cache/3caedb57c154f4c66adc1fae2b6a3bf5/f/m/fm22980bi28997_rv135848_sz6-removebg-preview.png"
},
...
"marca":"MAVALA",
"categoria": "maquillaje",
"description":"Los mini color, frascos pequeños con tapón dorado, nacen con una simple pero gran idea. Los esmaltes de uñas, independientemente de la calidad, tarde o temprano tienden a secarse, especialmente cuando se abren con frecuencia. Los Mini Color de Mavala han sido diseñados para minimizar la evaporación del disolvente y evitar este problema. Gracias a su pequeño tamaño, usaras todo el contenido sin desperdiciar ni una gota.",
...
"marca":"ALFAPARF",
"categoria": "shampoo",
"description":"Shampoo hidratante. Contenido: 250ml.Limpia delicadamente y nutre la fibra capilar. Contiene: • Urban Defence Pro3: Escudo anticontaminación para una protección total. • Shine Fix: 24 horas de brillo de la raíz a las puntas. • Color Fix Complex: Filtro UVA&UVB y antioxidantes para la protección del color. Sin sulfatos. APLICACIÓN: Distribuir sobre el cabello húmedo y emulsionar.",
...
"marca":"LA PUISSANCE",
"categoria": "shampoo",
"description":"Nutrí e hidratá tu cabello con este Shampoo altamente nutritivo con aceite de argán y ácido hialuronato. Una exclusiva fórmula de alta gama especialmente creada para los cabellos resecos y sensibilizados que genera un perfecto efecto de nutrición intensa y extraordinaria desde la primera aplicación. La innovadora y eficaz creación de La Puissânce, ofrece a cada hebra una suavidad única y brillo infinito, desde la raíz hasta la punta, gracias a su elevado contenido de aceite de argán y ácido hialurónico, preciadas sustancias ricas en componentes naturales. Ligereza del cabello con deslumbrante movimiento y vitalidad excepcional.",
...
"marca":"LA PUISSANCE",
"categoria": "shampoo",
"description":"Shampoo altamente nutritivo con aceite de coco y glicerol. Rehidrata y nutrí tu cabello de raíz a puntas, con la máxima frescura del coco. Ideal para cabellos resecos. Exclusiva fórmula que higieniza delicadamente los cabellos, retirando su grasitud, residuos y células muertas acumuladas. Sus micropartículas de óleo de coco y glicerol se depositan en las zonas más resecas y dañadas de la cutícula potenciando una nutrición intensa desde la raíz hasta las puntas. Brillo natural y sedosidad única.",
...
"marca":"ALFAPARF",
"categoria": "shampoo",
"description":"Shampoo delicado volumizante y corporizante para cabellos finos: limpia delicadamente y aporta espesor a la fibra capilar para un volumen natural. Semi Di Lino Volume es la línea de tratamiento desarrollada específicamente para dar densidad a los cabellos finos y apelmazados, hidratarlos y evitar que la humedad y los agentes atmosféricos comprometan su belleza natural. Da volumen, cuerpo e hidrata. Los cabellos finos adquieren cuerpo y grosor. La tecnología a prueba de clima: es el activo de Semi di Lino capaz de mantener el nivel óptimo de hidratación y para proteger el cabello a medida que cambian las condiciones climáticas, dependiendo de la humedad y la temperatura. El activo específico de la línea: VOLUME BOOST COMPLEX: es un polímero biocompatible que ayuda a reestructurar la fibra capilar desde el interior, los cabellos finos recuperan volumen aumentando su diámetro sin perder ligereza y suavidad. Más volumen, durante más tiempo. Los productos de la línea Semi Di Lino Volume no contienen ingredientes de origen animal, ni derivados de los mismos.",
